...
def generate_postscript(invoice_dict):
    ...
    c.text(tables_x_pos, 16.9, r"""\begin{tabular*}{1.61\columnwidth}{|p{14cm}|p{4.65cm}|}
      \hline
      \textbf{NOMBRE O RAZON SOCIAL:} """+invoice_dict['partner_name']+r"""& \textbf{RIF:} """+invoice_dict['rif']+r""" \\
      \hline
    \end{tabular*}""")

    c.text(tables_x_pos, 16.46, r"""\begin{tabular*}{1.61\columnwidth}{|p{19.07cm}|}
      \hline
    ...
    c.text(tables_x_pos, table_products_y_pos, r"""\begin{tabular*}{1.61\columnwidth}{|p{2.3cm}|p{11cm}|p{2.3cm}|p{2.22cm}|}
      \hline
    ...
    #Total
    c.text(15.3, (table_products_y_pos - 2), r"""\begin{tabular}{r}
    ...
    c.text(tables_x_pos, 1.2, r"""\begin{tabular*}{19.5cm}{|p{19.1cm}|}
      \hline
